...
/***** Adding javascript and css *****/
	...
	function yasr_add_scripts () {
		...
		wp_enqueue_style( 'yasrcss', get_template_directory_uri() . '/yasr/css/yasr.css', FALSE, NULL, 'all' );

        //If choosen is light or not dark (force to be default)
        if (YASR_SCHEME_COLOR === 'light' || YASR_SCHEME_COLOR != 'dark' ) {
            wp_enqueue_style( 'yasrcsslightscheme', get_template_directory_uri() . '/yasr/css/yasr-table-light.css', array('yasrcss'), NULL, 'all' );
        }

        elseif (YASR_SCHEME_COLOR === 'dark') {
            wp_enqueue_style( 'yasrcssdarkscheme', get_template_directory_uri() . '/yasr/css/yasr-table-dark.css', array('yasrcss'), NULL, 'all' );
        }
		...
		wp_enqueue_script( 'rateit', get_template_directory_uri() . '/yasr/js/jquery.rateit.min.js' , array('jquery'), '1.0.22', TRUE );
        ...
        wp_enqueue_script( 'yasrfront', get_template_directory_uri() . '/yasr/js/yasr-front.js' , array('jquery', 'rateit'), '1.0.0', TRUE );

	}

    function yasr_add_admin_scripts () {

        wp_enqueue_style( 'yasrcss', get_template_directory_uri() . '/yasr/css/yasr-admin.css', FALSE, NULL, 'all' );
        wp_enqueue_style( 'wp-jquery-ui-dialog' ); //style

        wp_enqueue_script( 'rateit', get_template_directory_uri() . '/yasr/js/jquery.rateit.min.js' , array('jquery'), '1.0.20', TRUE );
        wp_enqueue_script( 'jquery-ui-dialog' ); //script

        wp_enqueue_script( 'yasradmin', get_template_directory_uri() . '/yasr/js/yasr-admin.js' , array('jquery', 'rateit'), '1.0.00', TRUE );
...
add_action('admin_init', 'yasr_shortcode_button_init');
    ...
    function yasr_register_tinymce_plugin($plugin_array) {
        $plugin_array['yasr_button'] = get_template_directory_uri() . '/yasr/js/addButton_tinymcs.js';
        return $plugin_array;
    }
