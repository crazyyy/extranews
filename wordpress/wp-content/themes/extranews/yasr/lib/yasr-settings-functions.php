	    	...
	    	?>
		    	...
		    	<div class="yasr-option-size">
			    	<input type="radio" name="yasr_general_options[auto_insert_size]" value="small" class="yasr-auto-insert-options-class" <?php if ($option['auto_insert_size']==='small' ) echo " checked=\"checked\" ";  ?> >
						<img src="<?php echo  get_template_directory_uri() . "/yasr/img/yasr-stars-small.png" ?>" class="yasr-img-option-size"><span class="yasr-text-options-size"><?php _e('Small', 'yasr')?></span>
				</div>
		    	...
		    	<input type="radio" name="yasr_general_options[auto_insert_size]" value="medium" class="yasr-auto-insert-options-class" <?php if ($option['auto_insert_size']==='medium' ) echo " checked=\"checked\" ";  ?> >
					<img src="<?php echo  get_template_directory_uri() . "/yasr/img/yasr-stars-medium.png" ?>" class="yasr-img-option-size"><span class="yasr-text-options-size"><?php _e('Medium', 'yasr')?></span>
				</div>
				...
				<input type="radio" name="yasr_general_options[auto_insert_size]" value="large" class="yasr-auto-insert-options-class" <?php if ($option['auto_insert_size']==='large' ) echo " checked=\"checked\" ";  ?> >
					<img src="<?php echo  get_template_directory_uri() . "/yasr/img/yasr-stars-large.png" ?>" class="yasr-img-option-size"><span class="yasr-text-options-size"><?php _e('Large', 'yasr')?></span>
				</div>
		    	...
		    	<input type="radio" name="yasr_general_options[snippet]" value="visitor_rating" class="yasr_choose_snippet" <?php if ($option['snippet']==='visitor_rating') echo " checked=\"checked\" "; ?> >
		   		...
		   		<div id="yasr-snippet-explained" style="display:none">
		   			<?php
		   				...
		   				echo "<br /><br /><img src=" . get_template_directory_uri() . "/yasr/img/yasr_review.png>";

		   				echo "<br /> <br />";

		   				_e("If, instead, you choose \"Aggregate Rating\", your site will be indexed like this", "yasr");
		   				echo "<br /><br /><img src=" . get_template_directory_uri() . "/yasr/img/yasr_aggregate.jpg>";
		   			 ?>
		   		</div>
		...
		function yasr_color_scheme_callback($option_multiset) {
			...
			<div id="yasr-color-scheme-preview" style="display:none">
		   			<?php
		   				...
		   				_e("Light theme", "yasr");
		   				echo "<br /><br /><img src=" . get_template_directory_uri() . "/yasr/img/yasr-multi-set.png>";

		   				echo "<br /> <br />";

		   				_e("Dark theme", "yasr");
		   				echo "<br /><br /><img src=" . get_template_directory_uri() . "/yasr/img/dark-multi-set.png>";
		   			 ?>
		   	</div>
    ...
    ?>
        ...
        <div class="yasr-settingsdiv">
            ...
            <?php
                ...
                echo "<img src=" . get_template_directory_uri() . "/yasr/img//addExclamation.png alt=icon /> =" ;
...
function yasr_donate_dx () {
    ...
    <div class="yasr-donatedivdx" style="display:none">
        ...
        <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=AXE284FYMNWDC">
            <?php echo("<img src=" . get_template_directory_uri() . "/yasr/img//paypal.png>"); ?>
        </a>
